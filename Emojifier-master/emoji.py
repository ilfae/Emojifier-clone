...
def main(argv):
    ...
    if(FLAGS.src_image.startswith("http")):
        # Download image
            ...
            argparse.download(FLAGS.src_image, out=tmp_file_name);
    else:
